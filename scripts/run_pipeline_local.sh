...
snakemake --snakefile Snakefile_get_denovo_updated_prg --use-singularity --stats "$LOG_DIR"/Snakefile_get_denovo_updated_prg.stats "$@" >"$LOG_DIR"/Snakefile_get_denovo_updated_prg.out 2>"$LOG_DIR"/Snakefile_get_denovo_updated_prg.err
sleep 60 # avoid locked directory issues
